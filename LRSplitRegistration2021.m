...
I = dicomread("20201203_2DpCASL.dcm");
...
for i = 1:numImages/2
    ...
    sumRegLeftControl = sumRegLeftControl + im2double(regLeftControl{i}.transformedImages{2});
    sumRegRightControl = sumRegRightControl + im2double(regRightControl{i}.transformedImages{2});
    sumRegLeftLabel = sumRegLeftLabel + im2double(regLeftLabel{i}.transformedImages{2});
    sumRegRightLabel = sumRegRightLabel + im2double(regRightLabel{i}.transformedImages{2});
...
%coregister the label to the control
...
%combine images to form the registered average control image
